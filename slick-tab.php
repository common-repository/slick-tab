<?php
/*
Plugin Name: WP Slick Tab
Plugin URI: http://www.freebloggingtricks.com/wp-slick-tab/
Description: Slide Out your desire page with this very simple and user friendly Slick Tab Plugin.
Version: 1.0.9
Author: Ataul Ghani
Author URI: http://www.freebloggingtricks.com/
...
// Define contants
define( 'SLICK_TAB_VERSION' , '1.0.1' );
...
class slick_tab {
	...
	function add_menu_items ( ) {
		 ...
		 */
		//add_menu_page(__('Slick Tab', 'slick-tab'), __('Slick Tab', 'slick-tab'), 'manage_options', $this->get_page('slick-tab'), array(&$this->settings, 'settings_page'));
		add_options_page(__('Slick Tab', 'slick-tab'), __('Slick Tab', 'slick-tab'), 'manage_options', $this->get_page('slick-tab'), array(&$this->settings, 'settings_page'));		
	} // END: add_menu_items() 

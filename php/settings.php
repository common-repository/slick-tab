							...
							<tr valign="left">
									<th scope="row">
										...
										<div id='donation' align="center">
											<strong><a href='#' onclick="window.open('http://freebloggingtricks.com/donate/')">» Donate to this plugin</a></strong>
										</div>
									...
									<td>
<strong><span style="color: #008000;"><a href="http://freebloggingtricks.com/wp-slick-tab/"><span style="color: #008000;">WP Slick Tab Pro</span></a> - <span style="color: #ff0000;">Get It Now!</span></span><strong></strong></strong>

										<br /><span><strong>Thank you for using Slick Tab! Like Us on <span style="color: #008000;"><a href="https://www.facebook.com/freebloggingtricks" target="_blank"><span style="color: #008000;">Facebook</span></a></span>.</strong>
										<br /><em>Please take a moment to Rate, Blog and spread the word to help support this plugin.</em>
										<br />Suggestions, Issues? Check out the <input type="button" value="Slick Tab Support Blog" class="button-secondary" onclick="window.open('http://freebloggingtricks.com/wp-slick-tab/')"</input> and post your questions there via commenting on support blog. 
										</span>
